...
class TestHomework:
    ...
    def test_check_tokens_false(self):
        ...
        for v in self.ENV_VARS:
            utils.check_default_var_exists(telegram_bot, v)

        telegram_bot.PRACTICUM_TOKEN = None
        telegram_bot.TELEGRAM_TOKEN = None
        telegram_bot.TELEGRAM_CHAT_ID = None

        func_name = 'check_tokens'
        utils.check_function(telegram_bot, func_name, 0)
        tokens = telegram_bot.check_tokens()
        assert not tokens, (
    ...
    def test_check_tokens_true(self):
        ...
        telegram_bot.PRACTICUM_TOKEN = 'sometoken'
        telegram_bot.TELEGRAM_TOKEN = '1234:abcdefg'
    ...
    def test_bot_init_not_global(self):
        ...
        assert not (hasattr(telegram_bot, 'bot') and isinstance(getattr(telegram_bot, 'bot'), telegram.Bot)), (
    ...
    def test_logger(self, monkeypatch, random_timestamp):
        ...
        assert hasattr(telegram_bot, 'logging'), (
    ...
    def test_send_message(self, monkeypatch, random_timestamp):
        ...
        import telegram_bot
        utils.check_function(telegram_bot, 'send_message', 2)
    ...
    def test_get_api_answers(self, monkeypatch, random_timestamp,
        ...
        utils.check_function(telegram_bot, func_name, 1)

        result = telegram_bot.get_api_answer(current_timestamp)
    ...
    def test_get_500_api_answer(self, monkeypatch, random_timestamp,
        ...
        func_name = 'get_api_answer'
        try:
            telegram_bot.get_api_answer(current_timestamp)
        except:
            pass
        else:
            assert False, (
    ...
    def test_parse_status(self, random_timestamp):
        ...
        result = telegram_bot.parse_status(test_data)
    ...
    def test_check_response(self, monkeypatch, random_timestamp,
        ...
        response = telegram_bot.get_api_answer(current_timestamp)
        status = telegram_bot.check_response(response)
        assert status, (
    ...
    def test_parse_status_unknown_status(self, monkeypatch, random_timestamp,
        ...
        func_name = 'parse_status'
        response = telegram_bot.get_api_answer(current_timestamp)
        homeworks = telegram_bot.check_response(response)
        for hw in homeworks:
            status_message = None
            try:
                status_message = telegram_bot.parse_status(hw)
            except:
                pass
            else:
                assert False, (
    ...
    def test_check_response_no_homeworks(self, monkeypatch, random_timestamp,
        ...
        result = telegram_bot.get_api_answer(current_timestamp)
        try:
            telegram_bot.check_response(result)
        except:
            pass
        else:
            assert False, (
